  ...
  return (
    <div className="p-6 space-y-8 max-w-4xl mx-auto">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-2">Welcome to HomeMind AI! This guide will help you understand how to use the platform to manage your household easily.</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="glass-panel p-6 border-indigo-500/20">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg font-bold text-slate-100">1. Dashboard & Overview</h2>
          </div>
        ...
        <div className="glass-panel p-6 border-emerald-500/20">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg font-bold text-slate-100">2. Privacy & Family Workspace</h2>
          </div>
        ...
        <div className="glass-panel p-6 border-rose-500/20">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg font-bold text-slate-100">3. Income, Expenses & Bills</h2>
          </div>
          <p className="text-sm text-slate-300 leading-relaxed">
        ...
        <div className="glass-panel p-6 border-amber-500/20">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg font-bold text-slate-100">4. Pantry Vision (AI Scanning)</h2>
          </div>
          <p className="text-sm text-slate-300 leading-relaxed">
        ...
        <div className="glass-panel p-6 border-blue-500/20">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg font-bold text-slate-100">5. HomeMind AI Assistant</h2>
          </div>
          <p className="text-sm text-slate-300 leading-relaxed">
