    ...
    <div className="space-y-8 animate-in fade-in duration-200 pb-16">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 glass-panel p-6 border-slate-800">
        <div>
          ...
          <p className="text-xs text-slate-400">Configure household currency, regional defaults, AI features & privacy</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="glass-panel p-6 space-y-5 border-slate-800">
          <div className="flex items-center gap-3 border-b border-slate-800 pb-3">
            ...
            <div>
              <h3 className="font-bold text-sm text-slate-100">Multi-Currency & Country Configuration</h3>
              <p className="text-[11px] text-slate-400">Updates all prices, reports, forecasts & AI context instantly</p>
            </div>
          </div>

          <div className="space-y-4">
            <div>
              <label className="text-xs font-semibold text-slate-300 block mb-1.5">Primary Household Country</label>
              <select
                value={country}
            ...
            <div>
              <label className="text-xs font-semibold text-slate-300 block mb-1.5">Preferred Currency (12 Supported)</label>
              <select
                value={currency}
                onChange={(e) => handleCurrencyChange(e.target.value)}
                className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-xs text-slate-100 focus:outline-none focus:border-blue-500/50 font-medium"
              >
            ...
            <div className="grid grid-cols-2 gap-3 pt-1">
              <div className="bg-slate-950/40 border border-slate-800/60 p-3 rounded-xl">
                <span className="text-[10px] text-slate-500 block">Active Symbol</span>
                <span className="font-mono text-base font-bold text-emerald-400">
                  {SUPPORTED_CURRENCIES[currency]?.symbol || '$'}
                </span>
              </div>
              <div className="bg-slate-950/40 border border-slate-800/60 p-3 rounded-xl">
                <span className="text-[10px] text-slate-500 block">Measurement Unit</span>
                <span className="text-xs font-bold text-slate-200">{unitSystem} System</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="glass-panel p-6 space-y-5 border-slate-800">
          <div className="flex items-center gap-3 border-b border-slate-800 pb-3">
            ...
            <div>
              <h3 className="font-bold text-sm text-slate-100">Regional & Theme Customization</h3>
              <p className="text-[11px] text-slate-400">Time zone, date format & visual theme interface</p>
            </div>
          </div>

          <div className="space-y-4">
            <div>
              <label className="text-xs font-semibold text-slate-300 block mb-1.5">Visual Theme Mode</label>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-xs font-semibold text-slate-300 block mb-1.5">Time Zone</label>
                <input
                  type="text"
                  value={timeZone}
                  onChange={(e) => useSettingStore.setState({ timeZone: e.target.value })}
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-xs text-slate-100 focus:outline-none focus:border-purple-500/50 font-mono"
                />
              </div>
              <div>
                <label className="text-xs font-semibold text-slate-300 block mb-1.5">Date Format</label>
                <input
                  type="text"
                  value={dateFormat}
        ...
        <div className="glass-panel p-6 space-y-5 border-slate-800">
          <div className="flex items-center gap-3 border-b border-slate-800 pb-3">
            ...
            <div>
              <h3 className="font-bold text-sm text-slate-100">AI Microservice Toggles</h3>
              <p className="text-[11px] text-slate-400">Enable or disable intelligent background automation</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 rounded-xl bg-slate-950/40 border border-slate-800/60">
              <div>
                <span className="text-xs font-semibold text-slate-200 block">AI Smart Recommendations</span>
                <span className="text-[10px] text-slate-500">Savings & budget ceiling optimization alerts</span>
              </div>
              <input
                type="checkbox"
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-slate-950/40 border border-slate-800/60">
              <div>
                <span className="text-xs font-semibold text-slate-200 block">Predictive Utility Forecasting</span>
                <span className="text-[10px] text-slate-500">Polynomial regression for upcoming utility bills</span>
              </div>
              <input
                type="checkbox"
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-slate-950/40 border border-slate-800/60">
              <div>
                <span className="text-xs font-semibold text-slate-200 block">Zero-Food-Waste Recipe Engine</span>
                <span className="text-[10px] text-slate-500">Inventory expiry matching recipes</span>
              </div>
              <input
                type="checkbox"
                checked={aiRecipes}
        ...
        <div className="glass-panel p-6 space-y-5 border-slate-800">
          <div className="flex items-center gap-3 border-b border-slate-800 pb-3">
            ...
            <div>
              <h3 className="font-bold text-sm text-slate-100">Data Export & Privacy Controls</h3>
              <p className="text-[11px] text-slate-400">Download telemetry backups or purge household records</p>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-1">
            <button
              ...
              className="w-full bg-slate-950 hover:bg-slate-900 border border-slate-800 text-slate-200 text-xs font-semibold py-2.5 rounded-xl flex items-center justify-center gap-2 transition-all"
            >
