  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-400">Carbon footprint reduction, food waste minimization and eco-efficiency rating</p>
      </div>
      ...
      <div className="glass-panel p-6 border-emerald-500/40 bg-gradient-to-r from-slate-900 via-emerald-950/20 to-slate-900 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="space-y-2">
          ...
          <h2 className="text-4xl font-extrabold text-slate-100">86.5 <span className="text-lg text-emerald-400 font-normal">/ 100 (A Rating)</span></h2>
          <p className="text-xs text-slate-300">Your household is in the top 12% most energy-efficient residences in San Francisco.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="glass-panel p-5 space-y-2 border-emerald-500/30">
          <div className="flex items-center gap-2 text-emerald-400">
            ...
            <h3 className="font-semibold text-xs text-slate-200">Food Waste Reduced</h3>
          </div>
          <p className="text-2xl font-bold text-slate-100">1.8 kg / mo</p>
        ...
        <div className="glass-panel p-5 space-y-2 border-amber-500/30">
          <div className="flex items-center gap-2 text-amber-400">
            ...
            <h3 className="font-semibold text-xs text-slate-200">Electricity Footprint</h3>
          </div>
          <p className="text-2xl font-bold text-slate-100">340 kWh</p>
          <p className="text-[11px] text-slate-400">Off-peak shift active</p>
        </div>

        <div className="glass-panel p-5 space-y-2 border-blue-500/30">
          <div className="flex items-center gap-2 text-blue-400">
            <Droplet className="w-4 h-4" />
            <h3 className="font-semibold text-xs text-slate-200">Water Conservation</h3>
          </div>
          <p className="text-2xl font-bold text-slate-100">4,200 Litres</p>
