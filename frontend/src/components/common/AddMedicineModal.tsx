    ...
    <div className="fixed inset-0 z-50 bg-background/70 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-panel border border-primary rounded-3xl w-full max-w-md p-6 space-y-5 shadow-2xl relative animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="flex items-center gap-3 border-b border-primary pb-3">
          ...
          <div>
            <h3 className="font-bold text-base text-primary">Add Medicine Prescription</h3>
            <p className="text-xs text-muted">Save prescription details & daily dose times</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-xs font-semibold text-secondary block mb-1">Medicine Name</label>
            <input
              type="text"
              required
              ...
              className="w-full bg-background border border-primary rounded-xl px-3.5 py-2 text-xs text-primary focus:outline-none focus:border-purple-500/50"
            />
          </div>

          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs font-semibold text-secondary block mb-1">Dosage</label>
              <input
                type="text"
                required
                placeholder="500mg"
            ...
            <div>
              <label className="text-xs font-semibold text-secondary block mb-1">Stock Pill Count</label>
              <input
                type="number"
                required
                value={stockCount}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="text-xs font-semibold text-secondary block mb-1">Doctor Name</label>
              <input
                type="text"
          ...
          <div>
            <label className="text-xs font-semibold text-secondary block mb-1">Daily Schedule Times (Comma-separated)</label>
            <input
              type="text"
