        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between border-b border-slate-800 pb-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-extrabold text-base text-slate-100">Household Notifications</h2>
            </div>
          ...
          <div className="space-y-3 overflow-y-auto max-h-[calc(100vh-120px)] pr-1">
            {notifications.length === 0 ? (
              ...
              notifications.map((n) => (
                <div key={n.id} className="p-4 rounded-2xl bg-slate-950/60 border border-slate-800/80 space-y-1">
                  ...
                  <p className="text-xs text-slate-400 pl-6 leading-relaxed">{n.message}</p>
                </div>
              ))
            )}
          </div>
