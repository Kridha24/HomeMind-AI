...
export const ChatComposer: React.FC<ChatComposerProps> = ({
  ...
  return (
    <div className="p-3 sm:p-4 border-t border-slate-800/80 bg-slate-950/80 backdrop-blur-xl">
      <div className="relative flex items-end gap-2 bg-slate-900/90 border border-white/[0.08] focus-within:border-blue-500/50 rounded-2xl p-2 transition-colors shadow-lg">
        ...
        <button
          ...
          className="p-2 rounded-xl text-slate-400 hover:text-blue-400 hover:bg-slate-800/60 transition-colors shrink-0"
